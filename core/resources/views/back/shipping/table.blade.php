            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item"
                        href="{{ route('back.shipping.status', [$data->id, 1]) }}">{{ __('Enable') }}</a>
                    <a class="dropdown-item"
                        href="{{ route('back.shipping.status', [$data->id, 0]) }}">{{ __('Disable') }}</a>
                </div>
            </div>
        </td>
        <td>
            <div class="action-list">
                ...
                @if ($data->id != 1)
                    <a class="btn btn-danger btn-sm " data-toggle="modal" data-target="#confirm-delete"
                        href="javascript:;" data-href="{{ route('back.shipping.destroy', [$data->id]) }}">
