                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" id="peso" step="0.1" min="0" name="peso"
                                        class="form-control" placeholder="Peso" value="{{ old('peso') }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="alto">Alto (Cm)</label>
                                <div class="input-group mb-3">
                                    <input type="number" id="alto" step="0.1" min="0" name="alto"
                                        class="form-control" placeholder="Alto" value="{{ old('alto') }}" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="ancho">Ancho (Cm)</label>
                                <div class="input-group mb-3">
                                    <input type="number" id="ancho" step="0.1" min="0" name="ancho"
                                        class="form-control" placeholder="Ancho" value="{{ old('ancho') }}" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="largo">Largo (Cm)</label>
                                <div class="input-group mb-3">
                                    <input type="number" id="largo" step="0.1" min="0" name="largo"
                                        class="form-control" placeholder="Largo" value="{{ old('largo') }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="descripcionsat" name="descripcionsat" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="clavesat" name="clavesat" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="unidadsat" name="unidadsat" class="form-control"
