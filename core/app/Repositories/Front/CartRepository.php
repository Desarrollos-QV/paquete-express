...
class CartRepository
{
    ...
    public function store($request)
    {
        ...
        $item = Item::where('id', $input['item_id'])->select('id', 'name', 'photo', 'discount_price', 'previous_price', 'slug', 'item_type', 'license_name', 'license_key', 'stock', 'sku', 'alto', 'ancho', 'largo','peso')->first();
