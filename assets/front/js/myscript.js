...
$(document).on('change', '#shipping_id_select', function () {
    const warranty = $('option:selected', this).attr('data-warranty') === 'true';
    ...
    $('.set__shipping_price').text(`$${shippingPrice.toFixed(2)}`);
    $('.grand_total_set').text(`$${newTotal.toFixed(2)}`);
    $('.shipping_id_setup').val(shippingPrice.toFixed(2));
